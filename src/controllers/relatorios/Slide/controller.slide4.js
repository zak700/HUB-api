...
async function getSlide4(req, res) {
  try {
    ...
    const balanco = (rubrica) => {
      ...
      return [subRecO, subRec, natureza.subRS([subRecO, subRec])[0]];
    };
    ...
    output.receitas = [
      ...
      },
      {
        ...
        values: findDiv(balanco("intraOrcamentariaReceita")),
      },
    ];
...
*/
    ...
    console.error("error at getRreoAnexo from controller.slide4", error);
    return res.status(500).json({ message: "Internal server error." });
  }
}

export default { getSlide4 };
